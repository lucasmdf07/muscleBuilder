...
export default (props) => {
    ...
    return (
        <>
            ...
            <BalloonArea>
                {dayOff &&
                        <BalloonBigText><Strong>Rest Day</Strong></BalloonBigText>
                }
                {isFuture &&
                    <>
                        <BalloonBigText><Strong>Future Training Day</Strong></BalloonBigText>
                        <FutureTrainingLogo source={require('../assets/flex-biceps.png')} />
                    </>
                }
                {!dayOff && !isFuture && isDone &&
                    <>
                        <BalloonBigText><Strong>Congrats! You completed your training!</Strong></BalloonBigText>
                ...
                {!dayOff && !isFuture && !isDone && !isToday &&
                    <>
                        <BalloonBigText><Strong>You slacked! You didn't train!</Strong></BalloonBigText>
                ...
                {!dayOff && !isFuture && !isDone && isToday &&
                    <>
                        <BalloonBigText><Strong>You're scheduled to train today! 🚀</Strong></BalloonBigText>
